...
### 2.177.15
- Roll back plugin code and datasets to the stable 2.177.11 baseline
- Bumped plugin version
### 2.177.11
- Restore the "all points" view via a dedicated route option and share a consistent dataset with JavaScript
- Bumped plugin version
### 2.177.10
- Επαναφέρθηκε η έναρξη και το τέλος της Διαδρομής 2 στο «Μουσείο/έκθεση φωτογραφίας»
- Bumped plugin version
### 2.177.9
- Μεταφράστηκαν σε ελληνικά οι ενδείξεις απόστασης, χρόνου και υψομέτρου στο πάνελ πλοήγησης
- Bumped plugin version
### 2.177.8
- Μεταφράστηκαν όλα τα κουμπιά και οι ετικέτες στα ελληνικά
- Προστέθηκε κλείσιμο της Διαδρομής 2 με επαναλαμβανόμενο σημείο
- Bumped plugin version
### 2.177.7
