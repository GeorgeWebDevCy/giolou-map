...
== Changelog ==
= 2.177.15 =
* Reverted plugin functionality and dataset to the 2.177.11 baseline for stability
* Bumped plugin version
= 2.177.11 =
* Επανεμφάνιση όλων των σημείων ενδιαφέροντος με νέα επιλογή διαδρομής και κοινή δομή δεδομένων
* Bumped plugin version
= 2.177.10 =
...
* Bumped plugin version
= 2.177.8 =
* Translate all labels and buttons into Greek
* Close Route 2 loop with a returning coordinate
* Bumped plugin version
= 2.177.7 =
